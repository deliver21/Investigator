...
namespace Investigator.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, IUnitOfWork unit, UserManager<IdentityUser> userManager)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userToUpdate != null && userToUpdate.IsBlocked)
                {
                    ...
                    TempData["error"] = ("Sorry , you have been blocked :(");
                    return Page();
                }
                ...
                if (user != null)
                {
                    if (!await _userManager.IsEmailConfirmedAsync(user))
                    {
                        ...
                        if (userToUpdate != null)
                        {
                            ...
                            _unit.ApplicationUser.Update(userToUpdate);
                            _unit.Save();
                        }

                        _logger.LogInformation("User logged in without email confirmation.");
